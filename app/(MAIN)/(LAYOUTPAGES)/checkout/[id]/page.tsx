...
type CheckoutStep = "user-info" | "review" | "payment" | OrderStatus;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div
            className={`flex flex-col items-center ${currentStep === "user-info" ? "text-primary" : "text-muted-foreground"}`}
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${currentStep === "user-info" ? "bg-primary text-white" : "bg-muted"}`}
            >
          ...
          <div className="flex-1 h-1 mx-4 bg-muted">
            <div
              className={`h-full bg-primary ${currentStep === "user-info" ? "w-0" : currentStep === "review" ? "w-1/2" : "w-full"}`}
            ></div>
          </div>

          <div
            className={`flex flex-col items-center ${currentStep === "review" ? "text-primary" : currentStep === "payment" ? "text-primary" : "text-muted-foreground"}`}
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${currentStep === "review" ? "bg-primary text-white" : currentStep === "payment" ? "bg-primary text-white" : "bg-muted"}`}
            >
          ...
          <div className="flex-1 h-1 mx-4 bg-muted">
            <div
              className={`h-full bg-primary ${currentStep === "payment" ? "w-full" : "w-0"}`}
            ></div>
          </div>

          <div
            className={`flex flex-col items-center ${currentStep === "payment" ? "text-primary" : "text-muted-foreground"}`}
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${currentStep === "payment" ? "bg-primary text-white" : "bg-muted"}`}
            >
                ...
                <CardContent className="space-y-4">
                  ...
                  {paymentMethod === "stripe" && (
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        payment page after clicking &quot;Complete Order&quot;
                      </div>
                  ...
                  {paymentMethod === "delivery" && (
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      Pay the full amount in cash or card when your order
                      arrives
                    </div>
                  )}
                </CardContent>
